...
@ToString
public class SearchSpecification implements Specification<ReviewInvoiceEntity> {
    ...
    @Override
    public Specification<ReviewInvoiceEntity> and(Specification<ReviewInvoiceEntity> other) {
        return Specification.super.and(other);
    }

    @Override
    public Specification<ReviewInvoiceEntity> or(Specification<ReviewInvoiceEntity> other) {
        return Specification.super.or(other);
    }

    @Override
    public Predicate toPredicate(Root<ReviewInvoiceEntity> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
    ...
    private Predicate getPredicate(SearchCriteria param, CriteriaBuilder criteriaBuilder, Root<ReviewInvoiceEntity> root) {
